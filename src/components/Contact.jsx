...
export default function Contact() {
  return (
    ...
    >
      <div className="min-[768px]:flex-[90%] min-[1024px]:pr-10 min-[1224px]:pr-[4rem]">
        <h2 className="text-black-body-font text-heading-3 font-bold pb-[2rem] text-center min-[768px]:text-left">
          Let&apos;s Connect
        </h2>
        <p className="text-body-1 text-black-body-font pb-8 min-[1024px]:pb-0 min-[1224px]:pb-8 min-[1536px]:text-3xl">
